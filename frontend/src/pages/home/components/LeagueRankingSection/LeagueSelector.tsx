  ...
  return (
    <div className='relative'>
      <select
        ...
        aria-label='리그 선택'
        className='appearance-none rounded-lg border border-slate-200 bg-slate-50 py-1.5 pr-8 pl-3 text-sm font-medium text-slate-700 transition-colors hover:border-slate-300 hover:bg-slate-100 focus-visible:border-blue-500 focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 focus-visible:outline-none'
      >
